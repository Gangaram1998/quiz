    ...
    return (
        <>
            ...
            <Grid fontSize="20px" fontWeight="600" color="gray.700" templateColumns={{ base: "repeat(1, 1fr)", md: "repeat(2, 1fr)" }} gap={10} marginTop="40px" >
                ...
                <Box border="1px solid gray" borderRadius="20px" py="10px" bg={option === "b" ? "blue" : "none"} color={option === "b" ? "white" : "black"} onClick={show!==true?() => setOption("b"):null}>b. {optionB}</Box>
                <Box border="1px solid gray" borderRadius="20px" py="10px" bg={option === "c" ? "blue" : "none"} color={option === "c" ? "white" : "black"} onClick={show!==true?() => setOption("c"):null}>c. {optionC}</Box>
                <Box border="1px solid gray" borderRadius="20px" py="10px" bg={option === "d" ? "blue" : "none"} color={option === "d" ? "white" : "black"}  onClick={show!==true?() => setOption("d"):null}>d. {optionD}</Box>
            </Grid>
