    ...
    return (
        <>
            ...
            <Grid fontSize="20px" fontWeight="600" color="gray.700" templateColumns={{ base: "repeat(1, 1fr)", md: "repeat(2, 1fr)" }} gap={10} marginTop="40px" >
                <Box border="1px solid gray" borderRadius="20px" py="10px" bg={option === "a" ? "blue" : "none"} color={option === "a" ? "white" : "black"} readOnly={show===true} onClick={() => setOption("a")}>a. {optionA}</Box>
                <Box border="1px solid gray" borderRadius="20px" py="10px" bg={option === "b" ? "blue" : "none"} color={option === "b" ? "white" : "black"} readOnly={show===true} onClick={() => setOption("b")}>b. {optionB}</Box>
                <Box border="1px solid gray" borderRadius="20px" py="10px" bg={option === "c" ? "blue" : "none"} color={option === "c" ? "white" : "black"} readOnly={show===true} onClick={() => setOption("c")}>c. {optionC}</Box>
                <Box border="1px solid gray" borderRadius="20px" py="10px" bg={option === "d" ? "blue" : "none"} color={option === "d" ? "white" : "black"} readOnly={show===true} onClick={() => setOption("d")}>d. {optionD}</Box>
            </Grid>
